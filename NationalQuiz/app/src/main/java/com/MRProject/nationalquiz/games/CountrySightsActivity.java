            ...
            public void onClick(View v) {
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.dismiss();
                        finish();
                        Toast.makeText(CountrySightsActivity.this, getResources().getString(R.string.resultSaved), Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            yesBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (selectedAnswer.equals(selectedLanguage.equals("en") ? currentCountry.getNameEn() : currentCountry.getNameSr())) {
                        ...
                        Toast.makeText(CountrySightsActivity.this, getResources().getString(R.string.incorrectAnswer), Toast.LENGTH_SHORT).show();
